        ...
        if (args.length > 0) {
            ...
            if (subArg.contains(arg.toLowerCase())) {
                ...
                if (arg.equalsIgnoreCase("open")) {
                    ...
                    PCPageGui pcGui = new PCPageGui(StorageProxy.getPCForPlayerNow((other == null ? player : other).getUniqueId()).getBox(page - 1));
                ...
                if (arg.equalsIgnoreCase("search")) {
                    ...
                    List<Pokemon> pokemons = Lists.newArrayList(
                            StorageProxy.getPCForPlayerNow(player.getUniqueId()).getAll());
